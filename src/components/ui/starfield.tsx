...
export function StarfieldBackground({
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      // Background fade effect for trails
      ctx.fillStyle = isDark ? "rgba(10, 10, 15, 0.2)" : "rgba(250, 250, 250, 0.2)"
      ctx.fillRect(0, 0, width, height)

      const cx = width / 2
      const cy = height / 2
      const starColor = isDark ? "#ffffff" : "rgba(99, 102, 241, 0.7)"
  ...
  }, [count, speed, twinkle, isDark])

  return (
    <div
      ref={containerRef}
      className={cn(
        "fixed inset-0 overflow-hidden transition-colors duration-500",
      ...
      <div
        ...
        style={{
          background: isDark
            ...
            : "radial-gradient(ellipse at 30% 40%, rgba(99, 102, 241, 0.08) 0%, transparent 50%), radial-gradient(ellipse at 70% 60%, rgba(168, 85, 247, 0.05) 0%, transparent 50%)",
        }}
      />
      ...
      <div
        ...
        style={{
          background: isDark
            ...
            : "radial-gradient(ellipse at center, transparent 0%, transparent 40%, rgba(200,200,210,0.3) 100%)",
        }}
      />
