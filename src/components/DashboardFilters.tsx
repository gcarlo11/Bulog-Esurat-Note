...
export function DashboardFilters() {
  ...
  return (
    <div className="dashboard-filters-bar" style={{ display: "flex", gap: "8px", alignItems: "center", flexWrap: "wrap", marginBottom: "16px" }}>
      <div className="filter-date-row" style={{ display: "flex", gap: "6px", alignItems: "center" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "4px" }}>
          <span style={{ fontSize: "11px", color: "var(--text-secondary)", whiteSpace: "nowrap" }}>Dari:</span>
          <input
            type="date"
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "4px" }}>
          <span style={{ fontSize: "11px", color: "var(--text-secondary)", whiteSpace: "nowrap" }}>s/d:</span>
          <input
            type="date"
            className="filter-select"
            value={endDate}
